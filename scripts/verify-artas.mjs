...
const {rollerPath,gatePath,splitPanels,safeWireMove,validQuad,gateHeight}=await import(mechanicsURL);
const {products,nominalProfiles,assemblySteps}=await import(data(await compile('lib/artas/catalog.ts')));
